...
const RangeCircle = () => {
  ...
  if (ringRanges.length > 0) {
    ...
    const activeRingInfo =
      optimalRing >= 0
        ? ringRanges.find((r) => r.ringCount === optimalRing)
        : null;
    ...
    return (
      <>
        ...
        {minRange > 0 && (
          ...
          >
            <Tooltip sticky>
              <strong style={{ color: '#ef4444' }}>&#9888; Totzone</strong>
              <br />
              &lt; {minRange}m - Zu nah!
            </Tooltip>
          </Circle>
