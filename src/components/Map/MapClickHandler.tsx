...
const MapClickHandler = () => {
  ...
  const handleSetMortar = useCallback((coordinate: { east: number; north: number; height: number }) => {
    setMortarPosition(coordinate)
  }, [setMortarPosition])

  const handleSetTarget = useCallback((coordinate: { east: number; north: number; height: number }) => {
