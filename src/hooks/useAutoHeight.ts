...
export function useAutoHeight() {
  ...
  }, [mortarPosition?.east, mortarPosition?.north, mortarPosition?.height, mapConfig?.id, mapConfig?.hasHeightData])
  ...
  }, [targetPosition?.east, targetPosition?.north, targetPosition?.height, mapConfig?.id, mapConfig?.hasHeightData])
