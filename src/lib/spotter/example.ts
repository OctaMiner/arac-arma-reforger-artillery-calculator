...
console.log(`  Grid: ${Math.floor(spotterPosition.east)}${Math.floor(spotterPosition.north % 100).toString().padStart(2, '0')} / ${Math.floor(spotterPosition.north)}${Math.floor(spotterPosition.north % 100).toString().padStart(2, '0')}`)
...
console.log(`  East: ${target.east.toFixed(2)} (${Math.floor(target.east * 10)}m)`)
console.log(`  North: ${target.north.toFixed(2)} (${Math.floor(target.north * 10)}m)`)
console.log(`  Height: ${target.height.toFixed(1)}m`)
console.log(`  Grid: ${Math.floor(target.east)}${Math.floor((target.east % 1) * 100).toString().padStart(2, '0')} / ${Math.floor(target.north)}${Math.floor((target.north % 1) * 100).toString().padStart(2, '0')}\n`)
...
console.log(`  Grid: ${Math.floor(mortarPosition.east)}00 / ${Math.floor(mortarPosition.north)}00`)
...
const azimuthCorrectionMil = lateralToMilCorrection(correction1.leftRight, correction1.currentDistance)
...
console.log(`  Grid: ${Math.floor(desiredTarget.east)}00 / ${Math.floor(desiredTarget.north)}00\n`)

console.log('Beobachteter Einschlag:')
console.log(`  Grid: ${Math.floor(observedImpact.east)}${Math.floor((observedImpact.east % 1) * 100).toString().padStart(2, '0')} / ${Math.floor(observedImpact.north)}${Math.floor((observedImpact.north % 1) * 100).toString().padStart(2, '0')}\n`)
...
console.log(`  East: ${autoCorrectedTarget.east.toFixed(2)} (Differenz: ${(autoCorrectedTarget.east - desiredTarget.east).toFixed(2)})`)
console.log(`  North: ${autoCorrectedTarget.north.toFixed(2)} (Differenz: ${(autoCorrectedTarget.north - desiredTarget.north).toFixed(2)})\n`)
...
console.log(`  Position: ${Math.floor(spotter1Pos.east)}00 / ${Math.floor(spotter1Pos.north)}00`)
...
console.log(`  Position: ${Math.floor(spotter2Pos.east)}00 / ${Math.floor(spotter2Pos.north)}00`)
...
console.log(`  Alpha: East ${targetAlpha.east.toFixed(1)}, North ${targetAlpha.north.toFixed(1)}`)
console.log(`  Bravo: East ${targetBravo.east.toFixed(1)}, North ${targetBravo.north.toFixed(1)}`)
...
console.log(`  Grid: ${Math.floor(avgTarget.east)}${Math.floor((avgTarget.east % 1) * 100).toString().padStart(2, '0')} / ${Math.floor(avgTarget.north)}${Math.floor((avgTarget.north % 1) * 100).toString().padStart(2, '0')}\n`)
